...
\begin{center}
    ...
    \endlastfoot
    \header{0}{Basic}
    0.0  & \[ \lim_{x \to 30} x \]                                                                      & 1             & 1             & \green    \\ \hline
    0.1  & \[ \lim_{x \to -1} 1+x \]                                                                    & 0             & 0             & \green    \\ \hline
    0.2  & \[ \lim_{x \to \infty} 1-x \]                                                                & -\inf         & -\inf         & \green    \\ \hline
    0.3  & \[ \lim_{x \to 100\pi} cos(x)+sin(x) \]                                                      & 1             & 1             & \green    \\ \hline
    0.4  & \[ \lim_{x \to 50} e^{ln x} \]                                                               & 50            & 50            & \green    \\ \hline
    0.5  & \[ \lim_{x \to \pi} sin(x)cos(x) \]                                                          & 0             & 0             & \green    \\ \hline  
    0.6  & \[ \lim_{x \to 0} \frac{ln(x+1)}{x} \]                                                       & 1             & 1             & \green    \\ \hline
    0.7  & \[ \lim_{x \to 0} \frac{(1+x)^{42}-1}{x}\]                                                   & 42            & 42            & \green    \\ \hline
